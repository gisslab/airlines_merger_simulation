...
// label var lns_minus_lno "\$\ln(s\_{jt}/s_{0t})\$"
// label var lns_minus_ln_h "\$\ln(s\_{jt|h})\$"
// label var lns_minus_ln_g "\$\ln(s\_{ht|g})\$"
...
label var s_j_h "conditional share (Firm | Lower level)"
label var s_h_g "conditional nest share (Lower level | Upper level)"
