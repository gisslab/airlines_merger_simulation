...
// print for log
sum lns_minus_lno lns_minus_ln_g lns_minus_ln_h s_g s_h share s_jt s_0t s_inside_t s_g s_h
...
reghdfe lns_minus_lno `nest_lv1' `X_exog' `var_nest', ///
